...
| Keyring | Sway `exec_always` | `gnome-keyring-daemon`, optional DBus/systemd import | `dnf` desired | no | degraded secrets/SSH agent | modular-ready | Exits quietly when missing or already running. |
